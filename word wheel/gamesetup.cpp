...
void gamesetup::generate_word(vector<string> list_dic){
...
void gamesetup::verifWord (string s){
...
void gamesetup::affiche_suggested_correct_word()
{
...
void gamesetup::affiche_solution()
{
	for(int i=0;i<list_cor.size();i++){
		cout<<list_cor[i]<<endl;
	}
}
void gamesetup::score (){
	vector<string> tab(0) ;
...
void gamesetup::update(string nom ){
